...
- [x] Add full faction relations with goodwill and interaction history
- [x] Track colonist deaths with cause and date in StoryContext
- [x] Collect colonist relationships (romantic, family, social)
- [x] Include colonist childhood/adult backstory titles
- [x] Add weather, time of day, active conditions to context
- [x] Add specific resource counts (silver, steel, components)
- [x] Add prisoner names, factions, and capture context
- [x] Expand trait collection beyond 10 hardcoded notable traits
- [x] Add colonist mood levels and mental break history
- [x] Update PromptBuilder to format enriched context efficiently